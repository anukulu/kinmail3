...
DROP TABLE IF EXISTS `baby, toys and kids`;
CREATE TABLE IF NOT EXISTS `baby, toys and kids` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `beauty and health`;
CREATE TABLE IF NOT EXISTS `beauty and health` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(300) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `books and stationery`;
CREATE TABLE IF NOT EXISTS `books and stationery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `computer and gaming`;
CREATE TABLE IF NOT EXISTS `computer and gaming` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(300) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
(3, 'Samsung S24F350FHW 24-Inch LED Monitor With AH IPS', 16705, '', 'anukulparajuli599@gmail.com', '0b8aff0438617c055eb55f0ba5d226fa', 'Fixed Price', 'Brand New(Not Used)', '0', 1, 'nothing', 'YES', 'images/2 (4).jpg', 'images/3 (1)', 'NULL', ' Samsung Samsung S24F350FHW 24-Inch LED Monitor With AH IPS'),
...
(9, 'Cleaner Kit for Computer and Laptop', 100, '', 'stxavier_11c127@yahoo.com', 'abd815286ba1007abfbb8415b83ae2cf', 'Yes', 'Brand New(Not Used)', '0', 1, 'nothing', 'YES', 'images/c.jpg', 'images/', 'NULL', 'Cleaner Kit for Computer and Laptop'),
...
(11, 'Razer Goliathus Printed Keyboard And Mouse Pad', 475, '', 'anukulparajuli9@gmail.com', 'bd686fd640be98efaae0091fa301e613', 'Yes', 'Brand New(Not Used)', '8', 7, 'ppp', 'NO', 'images/mmm.jpg', 'images/', 'NULL', 'Razer Goliathus Printed Keyboard And Mouse Pad'),
...
DROP TABLE IF EXISTS `home and living`;
CREATE TABLE IF NOT EXISTS `home and living` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `mens fashion`;
CREATE TABLE IF NOT EXISTS `mens fashion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(300) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
(11, 'Ramesh Impex M1 Ninja Mask  Black', 229, '', 'atulthegreat7@gmail.com', 'd79aac075930c83c2f1e369a511148fe', 'Yes', 'Brand New(Not Used)', '0', 1, 'nothing', 'YES', 'images/1 (45).jpg', 'images/', 'NULL', 'Ramesh Impex M1 Ninja Mask  Black'),
...
(13, 'Culture Solid Regular Chinos Pants For Men Smokey Grey', 1325, '', 'anukulparajuli9@gmail.com', '559cb990c9dffd8675f6bc2186971dc2', 'Yes', 'Brand New(Not Used)', '0', 1, 'nothing', 'YES', 'images/1 (47).jpg', 'images/', 'NULL', 'Culture Solid Regular Chinos Pants For Men Smokey Grey'),
...
DROP TABLE IF EXISTS `other categories`;
CREATE TABLE IF NOT EXISTS `other categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
(9, 'Complan ChocolateJar1 kg', 775, '', 'anukulparajuli752@gmail.com', 'f7e9050c92a851b0016442ab604b0488', 'Yes', 'Brand New(Not Used)', '0', 1, 'nothing', 'YES', 'images/sdfsdf.jpg', 'images/', 'NULL', 'Complan ChocolateJar1 kg'),
...
DROP TABLE IF EXISTS `phones and tablets`;
CREATE TABLE IF NOT EXISTS `phones and tablets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(300) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `sports and travels`;
CREATE TABLE IF NOT EXISTS `sports and travels` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
(7, 'Liveup LS5765 Shoulder Support Black', 2475, '', 'stxavier_11c127@yahoo.com', 'fe131d7f5a6b38b23cc967316c13dae2', 'Fixed Price', 'Like New(Used Few Times)', '8', 7, 'ppp', 'NO', 'images/bodyyy.jpg', 'images/', 'NULL', 'Liveup LS5765 Shoulder Support Black'),
...
DROP TABLE IF EXISTS `tv, audio and cameras`;
CREATE TABLE IF NOT EXISTS `tv, audio and cameras` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(300) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
...
(7, 'Nikon D5300 With 18140mm Lens Get Free Camera Bag 16GB SD Card  Nikon Cleaning Kit  DSLR Camera', 90068, '', 'anukulparajuli@gmail.com', 'acf4b89d3d503d8252c9c4ba75ddbf6d', 'Yes', 'Like New(Used Few Times)', '0', 7, 'nothing', 'NO', 'images/dslr3.jpg', 'images/', 'NULL', 'Nikon D5300 With 18140mm Lens Get Free Camera Bag 16GB SD Card  Nikon Cleaning Kit  DSLR Camera');
...
DROP TABLE IF EXISTS `womens fashion`;
CREATE TABLE IF NOT EXISTS `womens fashion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(300) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `Description` varchar(255) NOT NULL,
